...
class LineControlNode(Node):
    def __init__(self):
        ...
        self.turn_steering_kp = 2.65  # proportional gain on turn-point offset (override)
        self.base_speed = 0.34  # forward speed when following (m/s)
        self.turn_speed = 0.34  # forward speed when turning (m/s)
